 ...
 */
public class StrongEnemy extends Tank {
    ...
    public StrongEnemy(float x, float y, ID id, Direction direction, Handler handler){
    ...
    public void tick() {
        ...
        if(direction == Direction.Up){
            player_image = ss.grabImage(3, 5, 64, 64);
            setDirection(Direction.Up);
        }else if(direction == Direction.Right){
            player_image = ss.grabImage(3, 6, 64, 64);// 1 6
            setDirection(Direction.Right);
        }else if(direction == Direction.Down){
            player_image = ss.grabImage(3, 7, 64, 64);//1 7
            setDirection(Direction.Down);
        }else if(direction == Direction.Left){
            player_image = ss.grabImage(3, 8, 64, 64);
